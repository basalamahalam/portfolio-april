...
const Navbar = () => {
  ...
  const getLinkClass = (path) => {
    return location.pathname === path
      ? "text-[#c75d2c]  lg:py-2"
      : "text-black hover:text-[#c75d2c] transition duration-500";
  };
  ...
  return (
    <>
      <div className="fixed top-0 left-0 z-30 flex items-center justify-between w-full max-w-full px-10 py-3 mx-auto text-black bg-opacity-75 h-18 2xl:px-64 xl:px-32 lg:px-20 md:py-0">
        <Link to="/">
          <p className="text-base font-bold tracking-widest text-[#c75d2c] font-lato md:text-lg">
            Afrilla
          </p>
        </Link>
        <div className="flex items-center justify-start">
          <ul className="items-center hidden md:flex">
            <li
              className={`p-4 font-poppins tracking-widest ${getLinkClass(
                "/"
              )}`}
            >
      ...
      >
        <ul className="flex flex-col px-10">
          <li
            onClick={handleNav}
            className={`mt-3 py-3 text-sm font-poppins tracking-widest ${getLinkClass(
              "/"
            )}`}
          >
          ...
          <li
            onClick={handleNav}
            className={`py-3 text-sm font-poppins tracking-widest ${getLinkClass(
              "/resume"
            )}`}
          >
          ...
          <li
            onClick={handleNav}
            className="py-3 text-sm tracking-widest font-poppins"
          >
            <a
